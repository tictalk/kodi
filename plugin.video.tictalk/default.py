...
base='http://tictalk.co.uk'
ADDON=xbmcaddon.Addon(id='plugin.video.tictalk')
...
def CATEGORIES():
    link = OPEN_URL('https://copy.com/nbI6u3eBcRCKJMVq').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("tictalk Wizard","Downloading ",'', 'Please Wait')
